...
public class AppRuntimeException extends RuntimeException {
    ...
    public AppRuntimeException(ResultInfoEnum resultInfoEnum) {
        this(resultInfoEnum.getErrorCode(), resultInfoEnum.getErrorMsg());
    }

    public AppRuntimeException(ResultInfoEnum resultInfoEnum, String extMessage) {
        this(resultInfoEnum.getErrorCode(), resultInfoEnum.getErrorMsg(extMessage));
    }
